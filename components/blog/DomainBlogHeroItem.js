...
export default function DomainBlogHeroItem({ name, post }) {
  // if (post == null) {
  //   return <></>;
  // }
  return (
    <div
      className={`w-full ml-1 p-1 cursor-pointer mb-8 md:mb-0 `}
    >
      <NextLink prefetch={false} href={name ? `${name}/${post?.slug}`|| "#" : post?.slug || "#"}>
