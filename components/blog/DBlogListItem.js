...
export default function DBlogListItem({ post, isFullWidth, name, showCategorey = false }) {
  ...
  return (
    ...
    >
      ...
      ></div>
      <div className="mt-4">
        {showCategorey && category && (
          <NextLink prefetch={false} href={`${name}/category/${category?.slug || ""}`}>
