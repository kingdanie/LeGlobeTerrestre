...
import { GET_UK_HOMEPAGE_DATA_QUERY } from "../../lib/apollo/queries/get-uk-home-page-content";
...
export default function UkHome({ data }) {
...
export async function getStaticProps() {
  const { data, errors } = await client.query({
    query: GET_UK_HOMEPAGE_DATA_QUERY,
  });
