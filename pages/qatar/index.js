...
import { GET_QATAR_HOMEPAGE_DATA_QUERY } from "../../lib/apollo/queries/get-qatar-home-page-content";
...
export default function QatarHome({ data }) {
...
export async function getStaticProps() {
  const { data, errors } = await client.query({
    query: GET_QATAR_HOMEPAGE_DATA_QUERY,
  });
