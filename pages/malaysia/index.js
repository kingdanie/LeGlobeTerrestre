...
import { GET_MALAYSIA_HOMEPAGE_DATA_QUERY } from "../../lib/apollo/queries/get-malaysia-home-page-content";
...
export default function MalaysiaHome({ data }) {
      ...
      <div id="page-wrapper" className="w-full mx-auto p-4">
        <div className="container mx-auto">
          <div className="flex flex-wrap -mx-3 overflow-hidden">
            ...
            <div className="mb-8">
                <LeftAccentedH2Text
                  text="Le Globe Terrestre Malaysia"
                  isCapitalize={true}
                />
            </div>
...
export async function getStaticProps() {
  const { data, errors } = await client.query({
    query: GET_MALAYSIA_HOMEPAGE_DATA_QUERY,
  });
