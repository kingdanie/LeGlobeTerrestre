...
import { GET_SINGAPORE_HOMEPAGE_DATA_QUERY } from "../../lib/apollo/queries/get-singapore-home-page-content";
...
export default function SingaporeHome({ data }) {
...
export async function getStaticProps() {
  const { data, errors } = await client.query({
    query: GET_SINGAPORE_HOMEPAGE_DATA_QUERY,
  });
