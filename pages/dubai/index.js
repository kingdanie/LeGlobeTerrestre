...
import { GET_DUBAI_HOMEPAGE_DATA_QUERY } from "../../lib/apollo/queries/get-dubai-home-page-content";
...
export default function DubiaHome({ data }) {
...
export async function getStaticProps() {
  const { data, errors } = await client.query({
    query: GET_DUBAI_HOMEPAGE_DATA_QUERY,
  });
