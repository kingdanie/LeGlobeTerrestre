...
import { GET_JAPAN_HOMEPAGE_DATA_QUERY } from "../../lib/apollo/queries/get-japan-home-page-content";
...
export default function JapanHome({ data }) {
...
export async function getStaticProps() {
  const { data, errors } = await client.query({
    query: GET_JAPAN_HOMEPAGE_DATA_QUERY,
  });
