...
import {
  GET_ALL_SEYCHELLES_CATEGORY_PAGE,
  SEYCHELLES_CATEGORY_SLUGS,
...
export default function SeychellesCategoryPage({ data = {}, footerMenus, categoryName }) {
  return (
...
export async function getStaticProps({ params }) {
  ...
  const { data, error } = await  client.query({
    query: slug == "all" ? GET_ALL_SEYCHELLES_CATEGORY_PAGE : GET_CATEGORY_PAGE,
    variables: {
      initialCount: 10,
      categorySlug: slug,
    },
