...
import { GET_SEYCHELLES_HOMEPAGE_DATA_QUERY } from "../../lib/apollo/queries/get-seychelles-home-page-content";
...
export default function SeychellesHome({ data }) {
...
export async function getStaticProps() {
  const { data, errors } = await client.query({
    query: GET_SEYCHELLES_HOMEPAGE_DATA_QUERY,
  });
