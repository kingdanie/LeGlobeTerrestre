...
import { GET_BALI_HOMEPAGE_DATA_QUERY } from "../../lib/apollo/queries/get-bali-home-page-content";
...
export default function BaliHome({ data }) {
...
export async function getStaticProps() {
  const { data, errors } = await client.query({
    query: GET_BALI_HOMEPAGE_DATA_QUERY,
  });
