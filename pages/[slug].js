...
export default function Post({ data, footerMenus }) {
  ...
  const [fetchPosts, { loading }] = useLazyQuery(GET_RELATED_AND_LATEST, {
...
export async function getStaticProps({ params }) {
  ...
  const { header, headerMenus, footerMenus, footer, subDomains, post } = postData?.data;
